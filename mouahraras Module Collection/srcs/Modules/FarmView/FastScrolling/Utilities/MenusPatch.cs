...
namespace mouahrarasModuleCollection.FarmView.FastScrolling.Utilities
{
	internal class MenusPatchUtility
	{
		internal static void ReceiveKeyPressPostfix(IClickableMenu __instance, Keys key)
		{
			...
			int offset = 2 * (int)(ModEntry.Config.FarmViewFastScrollingMultiplier - 1) * 4;
